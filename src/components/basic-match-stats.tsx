...
export function BasicMatchStats({ data }: BasicMatchStatsProps) {
  ...
  const stats = [
    ...
    { label: "평균 PC 성공률 (%)", h: formatValue(matchStats.home.pcSuccessRate), a: formatValue(matchStats.away.pcSuccessRate), isFloat: true },
    ...
    { label: "평균 빌드업 점유 비중 (%)", h: formatValue(matchStats.home.buildUpPossession), a: formatValue(matchStats.away.buildUpPossession), isFloat: true },
