...
import { Trophy, Database, Trash2, Edit3, Save, X, Plus, ChevronRight, FileUp, RefreshCw, ArrowLeft, ArrowUp, ArrowDown, Eye } from "lucide-react"
                          ...
                          {editingMatchId === m.id ? (
                            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                              <Input 
                                ...
                                onKeyDown={(e) => e.key === 'Enter' && handleUpdateMatchName(m.id!)}
                                autoFocus
                              />
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <p className="font-bold text-base flex items-center gap-2">
                                  {m.matchName} <Eye className="h-3 w-3 opacity-0 group-hover:opacity-100" />
                                </p>
                      ...
                      {editingId === t.id ? (
                        <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                          <Input 
                            ...
                            className="h-8 text-sm font-bold"
                            onKeyDown={(e) => e.key === 'Enter' && handleUpdateTournament(t.id)}
                            autoFocus
                          />
