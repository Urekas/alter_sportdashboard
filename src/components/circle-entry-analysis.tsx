...
// 5방향(세부) — 태깅 라벨 기준 왼쪽→오른쪽: 좌_25 - CE_L 45(표시명 중앙_좌_25) - 중_25 -
// CE_R 45(표시명 중앙_우_25) - 우_25. 양 끝(좌_25/우_25)은 엔드라인(골대가 있는 위쪽 라인)
// 가까이서 옆으로 파고들어 골대 앞을 가로지르는 형태 — 코너 쪽에서 수평으로 시작해 안쪽
// (중앙)을 바라보는 화살표. 색상·굵기·화살촉·길이는 다른 화살표와 동일하게 맞춤.
// 가운데 CE_L/CE_R 45는 시작 높이(y1=17)는 3방향과 동일하되, 화살표가 중앙 쪽(안쪽)을
// 바라보도록 반대 방향으로 꺾음.
const ZONES_5 = [
  { key: 'FarLeft' as const, label: '좌_25', labelEn: '', textX: 4, x1: 2, y1: 1.5, x2: 14, y2: 1.5 },
  { key: 'MidLeft' as const, label: '중앙_좌_25', labelEn: '', textX: 17, x1: 17, y1: 17, x2: 23.0, y2: 8 },
  { key: 'Center' as const, label: '중_25', labelEn: '', textX: 27.5, x1: 27.5, y1: 17, x2: 27.5, y2: 6 },
  { key: 'MidRight' as const, label: '중앙_우_25', labelEn: '', textX: 38, x1: 38, y1: 17, x2: 32.0, y2: 8 },
